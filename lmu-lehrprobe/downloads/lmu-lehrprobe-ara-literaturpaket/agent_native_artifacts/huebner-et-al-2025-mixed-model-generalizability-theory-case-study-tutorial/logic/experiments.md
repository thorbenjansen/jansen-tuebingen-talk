...
- **Verifies**: C01
- **Setup**: Full-text source loaded from `pdftotext full source from raw/paper__huebner-et-al-2025-mixed-model-generalizability-theory-case-study-tutorial.pdf`.
- **Procedure**:
