...
- **Verifies**: C01
- **Setup**: Full-text source loaded from `pdftotext full source from raw/paper__weidlich-et-al-2024-emotional-motivational-effects-automated-personalized-formative-feedback-reference-frames.pdf`.
- **Procedure**:
